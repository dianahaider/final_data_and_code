...
do
	...
	do
		mkdir -p intermediate_files/all_trims/"F"$flen"R"$rlen
		...
		mv 03-DADA2d intermediate_files/all_trims/"F"$flen"R"$rlen
	done
done
...
do
	...
	do
		...
		mv 03-size-selected intermediate_files/all_trims/"F"$flen"R"$rlen
		cd intermediate_files/all_trims/"F"$flen"R"$rlen
